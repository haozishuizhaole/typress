...
public class ConfigCondition extends Condition {
	...
	public static class Criteria {
		private Boolean configKeyIsNull;
		private Boolean configKeyIsNotNull;
		private ConfigKey configKeyEqualTo;
		private ConfigKey configKeyNotEqualTo;
		private ConfigKey configKeyGreaterThan;
		private ConfigKey configKeyGreaterThanOrEqualTo;
		private ConfigKey configKeyLessThan;
		private ConfigKey configKeyLessThanOrEqualTo;
		private List<ConfigKey> configKeyIn;
		private List<ConfigKey> configKeyNotIn;
		private ConfigKey[] configKeyBetween;
		private ConfigKey[] configKeyNotBetween;
		...
		public Boolean getConfigKeyIsNull() {
			return configKeyIsNull;
		}

		public void configKeyIsNull() {
			this.configKeyIsNull = Boolean.TRUE;
		}

		public Boolean getConfigKeyIsNotNull() {
			return configKeyIsNotNull;
		}

		public void configKeyIsNotNull() {
			this.configKeyIsNotNull = Boolean.TRUE;
		}

		public ConfigKey getConfigKeyEqualTo() {
			return configKeyEqualTo;
		}

		public void configKeyEqualTo(ConfigKey value) {
			this.configKeyEqualTo = value;
		}

		public ConfigKey getConfigKeyNotEqualTo() {
			return configKeyNotEqualTo;
		}

		public void configKeyNotEqualTo(ConfigKey value) {
			this.configKeyNotEqualTo = value;
		}

		public ConfigKey getConfigKeyGreaterThan() {
			return configKeyGreaterThan;
		}

		public void configKeyGreaterThan(ConfigKey value) {
			this.configKeyGreaterThan = value;
		}

		public ConfigKey getConfigKeyGreaterThanOrEqualTo() {
			return configKeyGreaterThanOrEqualTo;
		}

		public void configKeyGreaterThanOrEqualTo(ConfigKey value) {
			this.configKeyGreaterThanOrEqualTo = value;
		}

		public ConfigKey getConfigKeyLessThan() {
			return configKeyLessThan;
		}

		public void configKeyLessThan(ConfigKey value) {
			this.configKeyLessThan = value;
		}

		public ConfigKey getConfigKeyLessThanOrEqualTo() {
			return configKeyLessThanOrEqualTo;
		}

		public void configKeyLessThanOrEqualTo(ConfigKey value) {
			this.configKeyLessThanOrEqualTo = value;
		}

		public List<ConfigKey> getConfigKeyIn() {
			return configKeyIn;
		}

		public void configKeyIn(List<ConfigKey> value) {
			this.configKeyIn = value;
		}

		public List<ConfigKey> getConfigKeyNotIn() {
			return configKeyNotIn;
		}

		public void configKeyNotIn(List<ConfigKey> value) {
			this.configKeyNotIn = value;
		}

		public ConfigKey[] getConfigKeyBetween() {
			return configKeyBetween;
		}

		public void configKeyBetween(ConfigKey beginValue, ConfigKey endValue) {
			this.configKeyBetween = new ConfigKey[]{beginValue, endValue};
		}

		public ConfigKey[] getConfigKeyNotBetween() {
			return configKeyNotBetween;
		}

		public void configKeyNotBetween(ConfigKey beginValue, ConfigKey endValue) {
			this.configKeyNotBetween = new ConfigKey[]{beginValue, endValue};
		}
